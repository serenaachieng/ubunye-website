...
const packages = [
  {
    ...
    description: 'Cover transport and materials for one Saturday tutoring session at Usasazo High School or Beautiful Gate Centre in Philippi.',
    price: 350,
...
const schools = [
  { name: 'Usasazo High School', area: 'Khayelitsha' },
  { name: 'Beautiful Gate Centre', area: 'Philippi' },
];

const facts = [
  { number: '100+', label: 'New volunteers recruited in 2026' },
  { number: '2',    label: 'Schools currently served' },
  { number: '5',    label: 'Subjects tutored' },
  { number: 'Free', label: 'Cost to every learner' },
];
...
export default function TeachOut() {
  ...
  function handleAdd(pkg) {
    addToCart({ id: pkg.id, title: pkg.title, npo: 'TeachOut', price: pkg.price });
  }
  ...
  return (
    <main>
      ...
      {/* HERO */}
      <section className="npo-hero" style={{ '--npo-colour': 'var(--gold)', '--npo-dark': '#b8920f' }}>
        <div className="container npo-hero__inner">
          ...
          <p className="npo-hero__sub">
            ...
            free, high-quality academic tutoring to high school learners in Khayelitsha and Philippi.
        ...
        <div className="container npo-split">
          <div className="npo-split__text">
            ...
            <p className="section-subtitle">
              TeachOut runs weekly tutoring sessions at partner schools, pairing UCT student
              volunteers with high school learners who need extra academic support. Sessions
              are structured around the national curriculum and led by volunteers who are
              studying the same subjects at university level.
            </p>
            <p className="section-subtitle" style={{ marginTop: 16 }}>
              In 2026, TeachOut hosted a Welcome Festival on 12 February that recruited
              over 100 new volunteers, followed by a full Volunteer Induction and Training
              session on 7 March. The organisation is now active at Usasazo High School
              in Khayelitsha, with its first learner introductory session held on 8 April 2026.
            </p>
          </div>
        ...
        <div className="container">
          ...
          <div className="npo-priorities">
            <div className="npo-priority-card" style={{ '--accent': 'var(--gold)' }}>
              ...
              <p>
                Addressing reduced volunteer sign-ups by developing stronger incentive
                structures and recognition systems for committed tutors.
              </p>
            </div>
            <div className="npo-priority-card" style={{ '--accent': 'var(--gold)' }}>
              ...
              <p>
                Building relationships with peer organisations both within and outside UCT
                through collaborative initiatives and learning exchanges.
              </p>
            </div>
            <div className="npo-priority-card" style={{ '--accent': 'var(--gold)' }}>
              ...
              <p>
                Prioritising direct learner impact over internal costs &mdash; ensuring
                every rand raised reaches the students it is meant for.
              </p>
            </div>
          </div>
        </div>
