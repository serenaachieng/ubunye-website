...
const packages = [
  ...
  },
  {
    ...
    description: 'Fund a full-day tournament for 120 learners including transport reimbursements (R50 per learner), lunch packs, and certificates.',
    price: 6800,
  ...
  },
  {
    ...
    description: 'Fund a large-scale tournament day for 200 learners, including full catering, transport, prizes, and a themed motion set.',
    price: 11400,
  ...
  },
  {
    ...
    description: 'Cover the full annual programme budget including 6 workshops, 3 tournaments, volunteer socials, and committee T-shirts.',
    price: 55000,
...
export default function Thethani() {
  ...
  function handleAdd(pkg) {
    addToCart({ id: pkg.id, title: pkg.title, npo: 'Thethani Debating League', price: pkg.price });
  }
  ...
  return (
    <main>
      ...
      {/* HERO */}
      <section className="npo-hero" style={{ '--npo-colour': 'var(--red)', '--npo-dark': '#922b21' }}>
        <div className="container npo-hero__inner">
          ...
          <h1 className="npo-hero__title">
            Teaching Cape Town to think critically, argue boldly, and lead.
          </h1>
        ...
        <div className="container npo-split">
          <div className="npo-split__text">
            ...
            <p className="section-subtitle" style={{ marginTop: 16 }}>
              Topics range from rape culture and the legacy of colonialism to democracy,
              mental health, and South African governance &mdash; real issues that matter
              to the young people debating them. This is not just sport. It is education
              for life in post-apartheid South Africa.
            </p>
          </div>
          <div className="npo-split__cards">
            <div className="npo-info-card" style={{ '--card-accent': 'var(--red)' }}>
              ...
              <p>
                Learners travel to UCT Upper Campus every other week for focus-group coaching
                sessions. Volunteers facilitate critical discussions on local and global issues
                alongside formal debate technique training.
              </p>
            </div>
            <div className="npo-info-card" style={{ '--card-accent': 'var(--red)' }}>
              ...
              <p>
                ...
                and senior (Grades 10&ndash;12) leagues. Top speakers and schools receive
                certificates, with learners reimbursed R50 for transport.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="npo-quote-section" style={{ background: 'var(--dark)' }}>
        <div className="container">
          ...
          <cite className="npo-quote__cite">
            Thando Kambule, Finance Director, Thethani Debating League &mdash;{' '}
            <a
      ...
      <section className="section section--light" id="support">
        <div className="container">
          ...
          <p className="section-subtitle" style={{ marginBottom: 48 }}>
            Sponsors are welcome to attend tournaments, present to learners, and theme
            debate motions around issues relevant to their organisation. TDL is entirely
            flexible &mdash; any amount of support is gratefully received.
          </p>
